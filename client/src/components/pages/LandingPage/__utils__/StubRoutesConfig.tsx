...
const stubRoutesConfig = [
	...
	},
	{
		...
		children: [
			{
				path: "/menu",
				element: <MenuItemsList context={DishesContext} namespace="Jedzenie" />,
			},
			{
				path: "/menu/softs",
				element: (
			...
			{
				path: "/menu/drinks",
				element: <MenuItemsList context={DrinksContext} namespace="Drinki" />,
			},
			{
				path: "/menu/alcohol",
				element: (
...
export default stubRoutesConfig;
